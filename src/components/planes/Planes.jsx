const Planes = () => {
    ...
    <div class=" flex flex-wrap -m-4">
      <div class="p-4 lg:w-1/3 ">
        <div class="h-full bg-blue-500 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative ">
         <h1 class="tracking-widest text-xs title-font font-medium text-gray-100 mb-1 ">Tipo de planes </h1>
          <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-100 mb-3">Plan de retiro</h1>
          <p class="text-white leading-relaxed mb-3">Buenas.</p>

          <div class="  p-4 lg:w-1/2 sm:w-1/2 ">
        <h2 class="font-medium title-font tracking-widest text-gray-100 mb-4 text-sm text-center sm:text-left">Qué contiene</h2>
  ...
  <button class="flex items-center text-white bg-gray-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded">
    Comenzamos?
    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5 ml-2" viewBox="0 0 24 24">
      ...
      <div class="p-4 lg:w-1/3">
        ...
        <h1 class="tracking-widest text-xs title-font font-medium text-gray-100 mb-1 ">Tipo de planes </h1>
          <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-100 mb-3">Pro-Plan Inicial</h1>
  ...
  <button class="flex items-center text-white bg-gray-400 border-0 py-2 px-4 focus:outline-none hover:bg-gray-500 rounded">
    ...
    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5 ml-2" viewBox="0 0 24 24">
      ...
      <div class="p-4 lg:w-1/3">
        ...
        <h1 class="tracking-widest text-xs title-font font-medium text-gray-100 mb-1 ">Tipo de planes </h1>
          <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-100 mb-3">Plan Inicial-Bienestar Esencial</h1>
          <p class="leading-relaxed mb-3">Buenas.</p>
